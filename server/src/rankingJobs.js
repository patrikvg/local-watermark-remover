...
function runRankingFfmpeg(job, encoder) {
  return new Promise((resolve, reject) => {
    const args = buildRankingArgs({
      ...
      titleFont: job.titleFont,
      titleSize: job.titleSize,
      titleWeight: job.titleWeight,
      titleColor: job.titleColor,
      titleAlign: job.titleAlign,
...
export function createRankingJob({
  ...
  const job = {
    ...
    title,
    titlePos,
    titleFont: String(titleFont || "arial"),
    titleSize: Number(titleSize) || 64,
    titleWeight: titleWeight === "regular" ? "regular" : "bold",
    titleColor: String(titleColor || "#ffffff"),
    titleAlign:
      titleAlign === "center" || titleAlign === "right" ? titleAlign : "left",
